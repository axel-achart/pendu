...
BASE_DIR = r"C:\Users\ndiay\Desktop\lptf\projets\pendu"
...
# sounds call
try:
    loose_sound = loose_sound = pygame.mixer.Sound(r"C:\Users\ndiay\Desktop\lptf\projets\pendu/sounds/loose.wav")
except pygame.error as e:
    print(f"Error loading sound: {e}")
    loose_sound = None
try:
    win_sound = win_sound = pygame.mixer.Sound(r"C:\Users\ndiay\Desktop\lptf\projets\pendu/sounds/win_1.wav")
except pygame.error as e:
    print(f"Error loading sound: {e}")
    win_sound = None
